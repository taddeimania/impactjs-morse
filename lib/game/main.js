...
MyGame = MainGame.extend({
    ...
    init: function() {
        ...
        var tommySpawn = this.background.getCharCoords(4, 2);
        this.tommy = ig.game.spawnEntity('EntityTommy', tommySpawn.x, tommySpawn.y, {tile: [4, 2]});
